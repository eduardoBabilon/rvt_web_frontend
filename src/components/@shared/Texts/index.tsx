...
export function Title1({ children, className = '', dataTestId }: Props) {
  return (
    <h1
      data-testid={dataTestId}
      className={twMerge(`text-4xl xl:text-5xl ${className}`)}
    >
      {children}
    </h1>
  );
...
export function Title2({ children, className = '', dataTestId }: Props) {
  return (
    <h1
      data-testid={dataTestId}
      className={twMerge(`text-3xl xl:text-4xl font-bold ${className}`)}
    >
      {children}
    </h1>
  );
...
export function Text1({ children, className = '', dataTestId }: Props) {
  return (
    <h1
      data-testid={dataTestId}
      className={twMerge(`text-2xl xl:text-3xl font-bold ${className}`)}
    >
      {children}
    </h1>
  );
...
export function Text2({ children, className = '', dataTestId }: Props) {
  return (
    <h2
      data-testid={dataTestId}
      className={twMerge(`text-xl xl:text-2xl ${className}`)}
    >
      {children}
    </h2>
  );
